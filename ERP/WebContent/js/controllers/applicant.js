erpApp.controller('applicant', function($scope,$http, $mdDialog,SERVER_URL,$rootScope,$mdToast,Auth,utils) {
	...
	$scope.populatePageList=function(){
		...
		httpparams.url = SERVER_URL + "applicant/list";
		httpparams.headers = {
	...
	$scope.showAddNewPage = function(ev) {
		...
		$scope.information = "ADD NEW APPLICANT";
		var addNewPageDialog = {
			controller : 'applicantDialog',
			templateUrl : 'views/applicantDialog.html',
	...
	$scope.showEditPage = function(ev, $index) {
		...
		$scope.information = "EDIT APPLICANT INFORMATION"
	...
	$scope.viewPageInformation = function(ev, $index) {
		...
		$scope.information = "VIEW APPLICANT INFORMATION"
