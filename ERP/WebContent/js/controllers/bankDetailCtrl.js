erpApp.controller('bankDetailCtrl', function($scope,$http, $mdDialog,SERVER_URL,$rootScope,$mdToast,Auth,utils) {
	...
	$scope.populatePageList=function(){
		...
		httpparams.url = SERVER_URL + "bankdetail/list";
		httpparams.headers = {
	...
	$scope.showAddNewPage = function(ev) {
		...
		$scope.information = "ADD NEW BANK";
		var addNewPageDialog = {
			controller : 'bankDetailDialogController',
			templateUrl : 'views/bankDetailDialog.html',
	...
	$scope.showEditPage = function(ev, $index) {
		...
		$scope.information = "EDIT Bank INFORMATION"
	...
	$scope.viewPageInformation = function(ev, $index) {
		...
		$scope.information = "VIEW BANK INFORMATION"
	...
	$scope.deletePage = function(index) {
		...
		httpparams.url = SERVER_URL + "bankdetail/delete/" + $scope.pages[index].id;
		httpparams.headers = {
				auth_token : Auth.getAuthToken()
			};
		$http(httpparams).then(function successCallback(data) {
			...
			utils.showToast("Delete bank sucessfully");
